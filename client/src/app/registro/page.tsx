...
export default function Page() {
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    console.log({ data });
    const fullName = `${getValues("nombre")} ${getValues("apellidos")}`;
      ...
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <Image
              alt=""
              src="https://images.unsplash.com/photo-1488134684157-fea2d81a5ec4?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <p className="mt-4 leading-relaxed text-white/90">
                Registrate para empezar a alquilar autos.
              </p>
            </div>
          </section>
